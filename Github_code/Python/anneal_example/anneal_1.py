...
if __name__ == "__main__":
    ...
    ia_detective, ib_detective, ic_detective = threshold_defects.threshold_point_defects(test_0620_1_use)

    print('ia的识别id为：', ia_detective, 'ib的识别id为：', ib_detective, 'ic的识别id为：', ic_detective, '\n')
    ...
    id_detective, ie_detective, ide_all = threshold_interstitials.threshold_interstitials(test_0620_1_use)
    print('id的识别id为：', id_detective, 'ie的识别id为：', ie_detective, '复合构型的识别结果：', ide_all)
