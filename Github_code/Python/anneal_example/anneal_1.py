...
if __name__ == "__main__":
    ...
    # Initialize 'percent_stand_test0620_1'
    ...
    for i in range(percent_stand_test0620_1.shape[0]):
        ...
        # all_points = test_line.shape[0]  #
        for j in range(7):
            stand_line = stand_all[j, :]
            # stand_line = stand_line[-all_points:]  # Get the data behind the standard data set for comparison
        ...
        tail_value = test_line[-1] - stand_all[max_index, -1]  #
