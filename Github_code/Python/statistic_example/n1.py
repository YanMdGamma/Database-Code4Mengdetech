...
if __name__ == "__main__":
    ...
    id_detective, ie_detective, ide = threshold_interstitials.threshold_interstitials(test_0620_1_use)
    print('id的识别id为：', id_detective, 'ie的识别id为：', ie_detective, 'ide的复合识别id为：', ide)
