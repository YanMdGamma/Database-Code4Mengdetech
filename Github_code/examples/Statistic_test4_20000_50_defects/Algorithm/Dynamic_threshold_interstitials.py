...
def threshold_interstitials(test_1_use):
    id_all = []
    id_pre = []
    id_all_id = []
    count_id = 0
    ...
    if id_all.shape[0] == 0:
        ...
        if contains_positive or contains_negative:
            ...
            #     print(ia_all)
            id_all = id_all.T
            idx_id = kmeans.fit_predict(id_all) + 1
            #
    ...
    print('ie_all_without = ', ie_all_without)
    deleted_rows = deleted_rows.to_numpy()
    deleted_rows = deleted_rows.T
    print('deleted_rows_numpy = ', deleted_rows)
    ...
    if ie_all.shape[0] == 0:
        ...
        if contains_positive or contains_negative:
            ...
            print('ide configuration Atomic ids of all ie types--------------------------------------')
            print(ied_e_final)
            # print(ia_all)
            # print(ia_all[:, 1])
